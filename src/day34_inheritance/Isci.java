...
public class Isci extends Muhasebe{
	...
	public static void main(String[] args) {
		...
		//Bu derse kadar hangi classdan bilgi elde etmek istiyorsak o class dan obje olusturduk
		//Inheritance ile bu mecburiyet ortadan kalkti
		//Child classda olusturdugum obje ile tum parent classlarda
		//bulunan variable ve methodlari inherite edebilirim
