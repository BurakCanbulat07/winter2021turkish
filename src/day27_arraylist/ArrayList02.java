...
public class ArrayList02 {
	public static void main(String[] args) {
     ...
     // .set(); istenen index deki elemani kaldirip yerine bizim istedigimiz elemani koyar
    ...
    // list.set(4, "Mustafa");//olmayan bir index kullanilirsa RTE verir
     ...
     //list.add(10, "Sefer"); // size dan buyuk kabul etmez
     ...
     //List'in elemanlarini siralayin
