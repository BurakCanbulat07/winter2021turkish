...
public class Scope1 {
   ...
   scan.close(); }
    ...
    public void method() {
    	System.out.println(sayi);// bu method static olmadigi icin instance lara direk erisebilir
    	sayi=sayi+20;//ve bu methodicerisinde gecerli olmak uzere degerini degistirebilir
