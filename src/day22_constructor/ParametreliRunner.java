...
public class ParametreliRunner {
	...
	public static void main(String[] args) {
		...
		ParametreliConstructor oto3 = new ParametreliConstructor("Toyota","Corolla");//1
		System.out.println(oto3.marka + " " + oto3.model + " " + oto3.yil + " " + oto3.kazasiVarMi);
		//Toyota Corolla 0 false

		
		ParametreliConstructor oto4 = new ParametreliConstructor("Toyota","Corolla",2010,true);//1
